...
const static std::unordered_map<Kind, std::pair<internal::Kind, std::string>>
    s_kinds{
        ...
        KIND_ENUM(Kind::FINITE_FIELD_BITSUM, internal::Kind::FINITE_FIELD_BITSUM),
        ...
        KIND_ENUM(Kind::FINITE_FIELD_LE, internal::Kind::FINITE_FIELD_LE),
        KIND_ENUM(Kind::FINITE_FIELD_GT, internal::Kind::FINITE_FIELD_GT),
        KIND_ENUM(Kind::FINITE_FIELD_GE, internal::Kind::FINITE_FIELD_GE),
        KIND_ENUM(Kind::INT_TO_FINITEFIELD, internal::Kind::INT_TO_FINITEFIELD),
        KIND_ENUM(Kind::FINITEFIELD_TO_NAT, internal::Kind::FINITEFIELD_TO_NAT),
        /* FP --------------------------------------------------------------- */
...
const static std::unordered_map<internal::Kind,
    ...
    s_kinds_internal{
        ...
        {internal::Kind::FINITE_FIELD_LE, Kind::FINITE_FIELD_LE},
        {internal::Kind::FINITE_FIELD_GT, Kind::FINITE_FIELD_GT},
        {internal::Kind::FINITE_FIELD_GE, Kind::FINITE_FIELD_GE},
        {internal::Kind::INT_TO_FINITEFIELD_OP, Kind::INT_TO_FINITEFIELD},
        {internal::Kind::INT_TO_FINITEFIELD, Kind::INT_TO_FINITEFIELD},
        {internal::Kind::FINITEFIELD_TO_NAT, Kind::FINITEFIELD_TO_NAT},
        /* FP -------------------------------------------------------------- */
...
const static std::unordered_map<Kind, internal::Kind> s_op_kinds{
    ...
    {Kind::INT_TO_FINITEFIELD, internal::Kind::INT_TO_FINITEFIELD_OP},
...
size_t Op::getNumIndicesHelper() const
{
  ...
  switch (k)
  {
    ...
    case Kind::INT_TO_FINITEFIELD: size = 1; break;
