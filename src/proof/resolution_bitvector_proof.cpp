...
void LFSCResolutionBitVectorProof::printTheoryLemmaProof(std::vector<Expr>& lemma,
                                               std::ostream& os,
                                               std::ostream& paren,
                                               const ProofLetMap& map)
{
  Debug("pf::bv") << "(pf::bv) LFSCResolutionBitVectorProof::printTheoryLemmaProof called"
                  << std::endl;
...
void LFSCResolutionBitVectorProof::printBBHelpers(std::ostream& os,
                                        std::ostream& paren,
                                        ProofLetMap& letMap)
{
